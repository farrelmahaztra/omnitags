    ...
    <div className="min-h-screen">
      ...
      <div className="container p-12 flex flex-col flex-1">
        ...
        <p className="text-lg mb-6 sm:w-3/4 lg:w-1/2 font-body text-slate-600">
          ...
          possible to reflect changes in which meta tags are important to have,
          as they sometimes become deprecated or become a negative SEO signal
          despite still being shown in popular meta tag generators and SEO
          tutorial articles (e.g. the keywords tag).
        </p>
